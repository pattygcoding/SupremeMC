...
public enum SMCArmorMaterials implements ArmorMaterial
{
    ...
    SMCArmorMaterials(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantmentValue, SoundEvent equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        this.name = name;
    ...
    public String getName() {
        return SupremeMC.MOD_ID + ":" + this.name;
    }
