...
import net.pattygcoding.suprememc.screens.slots.FreezerFuelSlot;
import net.pattygcoding.suprememc.screens.slots.FreezerResultSlot;
import org.jetbrains.annotations.NotNull;

public abstract class AbstractFreezerMenu extends RecipeBookMenu<Container> {
    ...
    protected AbstractFreezerMenu(MenuType<?> pMenuType, RecipeType<? extends FreezingRecipe> pRecipeType, RecipeBookType pRecipeBookType, int pContainerId, Inventory pPlayerInventory) {
        this(pMenuType, pRecipeType, pRecipeBookType, pContainerId, pPlayerInventory, new SimpleContainer(3), new SimpleContainerData(4));
    }

    protected AbstractFreezerMenu(MenuType<?> pMenuType, RecipeType<? extends FreezingRecipe> pRecipeType, RecipeBookType pRecipeBookType, int pContainerId, Inventory pPlayerInventory, Container pContainer, ContainerData pData) {
        ...
        this.addSlot(new FreezerFuelSlot(this, pContainer, 1, 56, 53));
        this.addSlot(new FreezerResultSlot(pPlayerInventory.player, pContainer, 2, 116, 35));
    ...
    protected boolean canSmelt(ItemStack pStack) {
        return this.level.getRecipeManager().getRecipeFor(this.recipeType, new SimpleContainer(new ItemStack[]{pStack}), this.level).isPresent();
    }
