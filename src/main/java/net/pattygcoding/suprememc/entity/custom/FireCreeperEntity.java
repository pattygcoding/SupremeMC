...
import net.pattygcoding.suprememc.entity.ai.FireCreeperSwellGoal;
import org.jetbrains.annotations.NotNull;

public class FireCreeperEntity extends Monster implements PowerableMob {
    ...
    public FireCreeperEntity(EntityType<? extends FireCreeperEntity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    protected void registerGoals() {
        this.goalSelector.addGoal(1, new FloatGoal(this));
        this.goalSelector.addGoal(2, new FireCreeperSwellGoal(this));
    ...
    protected void dropCustomDeathLoot(@NotNull DamageSource pSource, int pLooting, boolean pRecentlyHit) {
        ...
        if ($$3 != this && $$3 instanceof FireCreeperEntity $$4) {
    ...
    private void explodeCreeper() {
        if (!this.level().isClientSide) {
            ...
            this.dead = true;
            this.level().explode(this, this.getX(), this.getY(), this.getZ(), (float)this.explosionRadius * $$0, true, ExplosionInteraction.MOB);
            this.discard();
    ...
    static {
        DATA_SWELL_DIR = SynchedEntityData.defineId(FireCreeperEntity.class, EntityDataSerializers.INT);
        DATA_IS_POWERED = SynchedEntityData.defineId(FireCreeperEntity.class, EntityDataSerializers.BOOLEAN);
        DATA_IS_IGNITED = SynchedEntityData.defineId(FireCreeperEntity.class, EntityDataSerializers.BOOLEAN);
    }
}
